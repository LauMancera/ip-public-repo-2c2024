...
EMAIL_HOST = 'smtp.gmail.com'  # Cambia esto al proveedor que uses
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tu_correo@example.com'  # Cambia esto a tu correo
EMAIL_HOST_PASSWORD = 'tu_contraseña'  # Cambia esto a tu contraseña
